...
internal unsafe partial class StbImage
{
		...
		stbi__result_info* ri, int bpc)
	{
		...
		stbi__skip(s, 6);
		var channelCount = stbi__get16be(s);
		if (channelCount < 0 || channelCount > 16)
			return (byte*)(ulong)(stbi__err("wrong channel count") != 0 ? 0 : 0);
		var h = (int)stbi__get32be(s);
		var w = (int)stbi__get32be(s);
		if (h > 1 << 24)
			return (byte*)(ulong)(stbi__err("too large") != 0 ? 0 : 0);
		if (w > 1 << 24)
			return (byte*)(ulong)(stbi__err("too large") != 0 ? 0 : 0);
		var bitdepth = stbi__get16be(s);
		...
		stbi__skip(s, (int)stbi__get32be(s));
		stbi__skip(s, (int)stbi__get32be(s));
		var compression = stbi__get16be(s);
		if (compression > 1)
