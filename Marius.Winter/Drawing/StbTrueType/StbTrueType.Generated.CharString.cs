...
{
	public static void stbtt__csctx_close_shape(ref stbtt__csctx ctx)
	{
		if (ctx.first_x != ctx.x || ctx.first_y != ctx.y)
			stbtt__csctx_v(ref ctx, STBTT_vline, (int)ctx.first_x, (int)ctx.first_y, 0, 0, 0, 0);
	}

	public static void stbtt__csctx_rccurve_to(ref stbtt__csctx ctx, float dx1, float dy1, float dx2, float dy2,
		float dx3, float dy3)
	{
		var cx1 = ctx.x + dx1;
		var cy1 = ctx.y + dy1;
	...
	public static void stbtt__csctx_rline_to(ref stbtt__csctx ctx, float dx, float dy)
	{
		ctx.x += dx;
		ctx.y += dy;
	...
	public static void stbtt__csctx_rmove_to(ref stbtt__csctx ctx, float dx, float dy)
	{
	...
	public static void stbtt__csctx_v(ref stbtt__csctx c, byte type, int x, int y, int cx, int cy, int cx1, int cy1)
	{
		if (c.bounds != 0)
		{
	...
	public static void stbtt__track_vertex(ref stbtt__csctx c, int x, int y)
	{
	...
	public ref struct stbtt__csctx
	{
		public int bounds;
		public int started;
		...
		public int min_y;
		public int max_y;
		public UnsafeSpan<stbtt_vertex> pvertices;
