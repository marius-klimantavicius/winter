...
internal static unsafe class CRuntime
{
    ...
    public static void memcpy(void* dest, void* src, ulong size)
    {
        memcpy(dest, src, (long)size);
    }

    public static void memmove(void* dest, void* src, long size)
    {
        Buffer.MemoryCopy(src, dest, size, size);
    }

    public static void memmove(void* dest, void* src, ulong size)
    {
        memmove(dest, src, (long)size);
    }
    ...
    {
        new Span<byte>((byte*)ptr, (int)size).Fill((byte)value);
    }
    ...
    public static void* realloc(void* a, ulong newSize)
    {
        ...
        var ptr = new IntPtr(a);
        var result = Marshal.ReAllocHGlobal(ptr, new IntPtr((long)newSize));
    ...
    {
        var span = MemoryMarshal.CreateReadOnlySpanFromNullTerminated((byte*)str);
