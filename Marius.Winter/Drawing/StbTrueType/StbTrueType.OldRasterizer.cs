...
internal unsafe partial class StbTrueType
{
	...
	public static void stbtt__rasterize_sorted_edges_old_rasterizer(ref stbtt__bitmap result, stbtt__edge* e, int n, int vsubsample, int off_x, int off_y, void* userdata)
	{
