...
internal static class Utility
{
	...
	public static Color HSLA(float h, float s, float l, byte a)
	{
		...
		var fr = (float)(Clamp((float)(Hue((float)(h + 1.0f / 3.0f), (float)(m1), (float)(m2))), (float)(0.0f), (float)(1.0f)));
		var fg = (float)(Clamp((float)(Hue((float)(h), (float)(m1), (float)(m2))), (float)(0.0f), (float)(1.0f)));
		var fb = (float)(Clamp((float)(Hue((float)(h - 1.0f / 3.0f), (float)(m1), (float)(m2))), (float)(0.0f), (float)(1.0f)));
		var fa = (float)(a / 255.0f);
