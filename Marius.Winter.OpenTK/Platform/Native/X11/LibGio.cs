...
internal static class LibGio
{
    ...
    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe IntPtr /* GDBusProxy* */ g_dbus_proxy_new_for_bus_sync(
        GBusType bus_type,
    ...
    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe IntPtr /* GVariant* */ g_dbus_proxy_call_sync(
    ...
    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe IntPtr /* GVariant* */ g_variant_new(byte* /* const gchar* */ format_string, /* ... */ byte* str1, byte* str2);

    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe IntPtr /* GVariant* */ g_variant_ref(IntPtr /* GVariant* */ value);

    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe void g_variant_unref(IntPtr /* GVariant* */ value);

    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe void g_variant_get(IntPtr /* GVariant* */ value, byte* /* const gchar* */ format_string, /* ... */ out IntPtr /* GVariant* */ var1);

    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe void g_variant_get(IntPtr /* GVariant* */ value, byte* /* const gchar* */ format_string, /* ... */ out IntPtr /* GVariant* */ var1, out IntPtr /* GVariant* */ var2);

    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe void g_variant_get(IntPtr /* GVariant* */ value, byte* /* const gchar* */ format_string, /* ... */ out IntPtr /* GVariant* */ var1, out IntPtr /* GVariant* */ var2, out IntPtr /* GVariant* */ var3);
    ...
    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe void g_clear_error(GError **err);
    ...
    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe ulong /* gulong */ g_signal_connect_data(
        IntPtr /* gpointer */ instance,
        byte* /* const gchar* */ detailed_signal,
        IntPtr /* GCallback */ c_handler,
        IntPtr /* gpoiner */ data,
    ...
    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe IntPtr /* GPowerProfileMonitor* */ g_power_profile_monitor_dup_default();

    [DllImport(Gio, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe int /* gboolean */ g_power_profile_monitor_get_power_saver_enabled(IntPtr /* GPowerProfileMonitor* */ monitor);
