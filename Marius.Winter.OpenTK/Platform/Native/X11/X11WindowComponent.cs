...
public class X11WindowComponent : IWindowComponent
{
    ...
    private static readonly List<WindowBorderStyle> s_emptyStyleList = new List<WindowBorderStyle>();
            ...
            switch (ea.Type)
            {
                ...
                case XEventType.KeyPress:
                {
                    ...
                    unsafe {
                        ...
                        XLookupString(&keyPressed, null, 0, &keysym, null);
                        ...
                        bool plain = (modifiers & (KeyModifier.Control | KeyModifier.Alt)) == 0;
                        ...
                        if (plain)
                        {
                            var codepoint = X11KeyboardComponent.KeySymToUnicode(keysym);
                            if (codepoint != uint.MaxValue)
                                EventQueue.Raise(xwindow, PlatformEventType.TextInput, new TextInputEventArgs(xwindow, char.ConvertFromUtf32((int)codepoint)));
                        }
                    }
                    break;
                }
