...
#pragma warning disable CS0649
    ...
    internal static unsafe Span<XAtom> XRRListOutputProperties(XDisplayPtr display, RROutput output, out int nprop)
    {
        ...
        [DllImport(xrandr, CallingConvention = CallingConvention.Cdecl)]
        static extern unsafe XAtom* XRRListOutputProperties(XDisplayPtr display, RROutput output, out int nprop);
    }
    ...
    [DllImport(xrandr, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe XRROutputInfo* XRRGetOutputInfo(XDisplayPtr display, XRRScreenResources* resources, RROutput output);

    [DllImport(xrandr, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe void XRRFreeOutputInfo(XRROutputInfo* outputInfo);
    ...
    [DllImport(xrandr, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe XRRCrtcInfo* XRRGetCrtcInfo(XDisplayPtr display, XRRScreenResources* resources, RRCrtc crtc);

    [DllImport(xrandr, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe void XRRFreeCrtcInfo(XRRCrtcInfo* crtcInfo);
    ...
    [DllImport(xrandr, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe RRConfigStatus XRRSetCrtcConfig(XDisplayPtr dpy, XRRScreenResources* resources, RRCrtc crtc, XTime timestamp, int x, int y, RRMode mode, Rotation rotation, RROutput* outputs, int noutputs);
}
