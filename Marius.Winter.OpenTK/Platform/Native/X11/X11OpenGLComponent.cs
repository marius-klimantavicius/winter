...
public class X11OpenGLComponent : IOpenGLComponent
{
    ...
    private static readonly Dictionary<GLXContext, XOpenGLContextHandle> contextDict = new Dictionary<GLXContext, XOpenGLContextHandle>();
    ...
    public void Initialize(ToolkitOptions options)
    {
        ...
        Version.TryParse(Glx.QueryServerString(X11.Display, X11.DefaultScreen, StringName.Version), out var version);
