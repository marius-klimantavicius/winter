...
internal static unsafe class SDL
{
    ...
    private const string SDLLib = "SDL2";
    ...
    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe int SDL_PollEvent(SDLEvent* @event);
    ...
    private static extern unsafe char* SDL_GetDisplayName_internal(int displayIndex);
    ...
    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe int SDL_GetDisplayDPI(int displayIndex, out float ddpi, out float hdpi, out float vdpi);
    ...
    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe void SDL_free(void* ptr);

    [DllImport(SDLLib, EntryPoint = "SDL_GetClipboardText", CallingConvention = CallingConvention.Cdecl)]
    private static extern unsafe char* SDL_GetClipboardText_internal();
    ...
    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe SDL_Surface* SDL_CreateRGBSurfaceWithFormat(
        uint flags,
        int width,
        int height,
        int depth,
    ...
    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe bool SDL_IsGameController(int joystick_index);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe SDL_GameController* SDL_GameControllerFromPlayerIndex(int player_index);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe SDL_GameController* SDL_GameControllerOpen(int joystick_index);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe void SDL_GameControllerClose(SDL_GameController* gamecontroller);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe SDL_Joystick* SDL_GameControllerGetJoystick(SDL_GameController* gamecontroller);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe char* SDL_GameControllerName(SDL_GameController* gamecontroller);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe short SDL_GameControllerGetAxis(SDL_GameController* gamecontroller, SDL_GameControllerAxis axis);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe byte SDL_GameControllerGetButton(SDL_GameController* gamecontroller, SDL_GameControllerButton button);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe int SDL_GameControllerRumble(SDL_GameController* gamecontroller, ushort low_frequency_rumble, ushort high_frequency_rumble, uint duration_ms);
    ...
    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe SDL_Joystick* SDL_JoystickOpen(int device_index);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe void SDL_JoystickClose(SDL_Joystick* joystick);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe void SDL_JoystickUpdate();
    ...
    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe SDL_JoystickID SDL_JoystickInstanceID(SDL_Joystick* joystick);
    ...
    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe SDL_JoystickGUID SDL_JoystickGetGUID(SDL_Joystick* joystick);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe char* SDL_JoystickName(SDL_Joystick * joystick);

    [DllImport(SDLLib, CallingConvention = CallingConvention.Cdecl)]
    internal static extern unsafe SDL_JoystickPowerLevel SDL_JoystickCurrentPowerLevel(SDL_Joystick* joystick);
