...
public class MacOSDialogComponent : IDialogComponent
{
    ...
    private static readonly unsafe delegate* unmanaged[Cdecl]<IntPtr, SEL, IntPtr, IntPtr, IntPtr> NSOtkSyncModal_InitWithAlert_AsSheetForWindowInst = &NSOtkSyncModal_InitWithAlert_AsSheetForWindow;
    ...
    private static readonly unsafe delegate* unmanaged[Cdecl]<IntPtr, SEL, IntPtr, IntPtr, IntPtr, IntPtr, IntPtr, IntPtr> NSOtkSyncModal_InitWithOpenPanel_AsSheetForWindow_InDirectory_File_TypesInst = &NSOtkSyncModal_InitWithOpenPanel_AsSheetForWindow_InDirectory_File_Types;
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    ...
    private static readonly unsafe delegate* unmanaged[Cdecl]<IntPtr, SEL, IntPtr, IntPtr, IntPtr, IntPtr, IntPtr> NSOtkSyncModal_InitWithSavePanel_AsSheetForWindow_InDirectory_FileInst = &NSOtkSyncModal_InitWithSavePanel_AsSheetForWindow_InDirectory_File;
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    ...
    private static readonly unsafe delegate* unmanaged[Cdecl]<IntPtr, SEL, IntPtr, long> NSOtkSyncModal_RunInst = &NSOtkSyncModal_Run;
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    ...
    private static readonly unsafe delegate* unmanaged[Cdecl]<IntPtr, SEL, IntPtr, nint, IntPtr, void> NSOtkSyncModal_AlertDidEnd_ReturnCodeInst = &NSOtkSyncModal_AlertDidEnd_ReturnCode;
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    ...
    private static readonly unsafe delegate* unmanaged[Cdecl]<IntPtr, SEL, IntPtr, nint, IntPtr, void> NSOtkSyncModal_FilePanelDidEnd_ReturnCodeInst = &NSOtkSyncModal_FilePanelDidEnd_ReturnCode;
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
