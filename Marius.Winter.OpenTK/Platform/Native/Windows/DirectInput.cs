...
internal static class DirectInput
{
    ...
    [FixedAddressValueType]
    internal static readonly unsafe DIOBJECTDATAFORMAT[] c_dfDIJoystick_rgodf = new DIOBJECTDATAFORMAT[]
    {
    ...
    [FixedAddressValueType]
    internal static unsafe DIDATAFORMAT c_dfDIJoystick = new DIDATAFORMAT()
    {
