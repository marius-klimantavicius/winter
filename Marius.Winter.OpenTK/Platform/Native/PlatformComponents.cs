...
public static class PlatformComponents
{
    ...
    private static readonly Dictionary<PalComponents, ComponentCtor> sdlComponents =
    ...
    private static readonly Dictionary<PalComponents, ComponentCtor> win32Components =
        new Dictionary<PalComponents, ComponentCtor>
        {
    ...
    private static readonly Dictionary<PalComponents, ComponentCtor> x11Components =
        new Dictionary<PalComponents, ComponentCtor>
        {
    ...
    private static readonly Dictionary<PalComponents, ComponentCtor> macosComponents =
        new Dictionary<PalComponents, ComponentCtor>
        {
